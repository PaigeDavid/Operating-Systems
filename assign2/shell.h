...
This function appends str1 and str2 together into newString

function:
	- parameter(s): char* pointers that contain the original strings, and 
	  newString for storing the appended string with a '/' character in the
	  middle of the two strings.

	- return: newString that has been appended
